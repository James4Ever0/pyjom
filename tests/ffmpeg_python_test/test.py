...
def cropVideoRegion():
    ...
    stream_0 = ffmpeg.input("output.mp4",ss=0, to=2).crop(x,y,width, height).filter("pad",x=math.floor(()/2), y=math.floor(()/2), width=defaultWidth, height=defaultHeight,color="black")
