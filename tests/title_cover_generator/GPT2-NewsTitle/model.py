...
from transformers import GPT2PreTrainedModel, GPT2Model # change shit
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(self, input_ids=None, past=None, token_type_ids=None, labels=None, title_id=None): # why you got unexpected past?
        """
        前向函数，计算GPT2预测结果值
        Args:
        ...
        # transformer_outputs = self.transformer(input_ids, past=past, token_type_ids=token_type_ids) #freaking changed
