...
if __name__ == "__main__":
    ...
    # so we don't have to run it all the time. really?
        ...
        scriptFilePath = "/root/Desktop/works/pyjom/tests/medialang_tests/aef2ab90-6414-4b55-a40e-63014e5648a8.mdl" # add random flips, picture enhancement, superresolution and minterpolate
        # a special hack
        # import tempfile
