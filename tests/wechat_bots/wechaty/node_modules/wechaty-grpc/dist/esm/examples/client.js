...
export async function testAlias(client) {
...
export async function testDing(client) {
...
export function testStream(client) {
...
async function main() {
    ...
    const client = new puppet.PuppetClient('localhost:8788', creds, {
