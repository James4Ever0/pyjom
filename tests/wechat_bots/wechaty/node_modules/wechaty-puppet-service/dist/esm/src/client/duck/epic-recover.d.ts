...
declare const monitorHeartbeat$: (timeoutMilliseconds: number) => (action$: Observable<AnyAction>) => Observable<import("typesafe-actions").PayloadMetaAction<"wechaty-redux/ERROR_RECEIVED_EVENT", import("wechaty-puppet/payloads").EventError, {
    puppetId: string;
}>>;
