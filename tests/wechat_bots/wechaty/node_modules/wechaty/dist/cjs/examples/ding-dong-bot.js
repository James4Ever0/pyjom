 ...
 *
 */
const mod_js_1 = require("../src/mods/mod.js"); // from 'wechaty'
...
const bot = mod_js_1.WechatyBuilder.build(options);
/**
 *
...
function onScan(qrcode, status) {
    if (status === mod_js_1.ScanStatus.Waiting || status === mod_js_1.ScanStatus.Timeout) {
        qrcode_terminal_1.default.generate(qrcode);
        const qrcodeImageUrl = [
            'https://wechaty.js.org/qrcode/',
            encodeURIComponent(qrcode),
        ].join('');
        console.info('onScan: %s(%s) - %s', mod_js_1.ScanStatus[status], status, qrcodeImageUrl);
    }
    else {
        console.info('onScan: %s(%s)', mod_js_1.ScanStatus[status], status);
    }
