...
def getBilibiliPostMetadataForDogCat(sleepTime=2):
    ...
    while True:
        try:
            ...
            # breakpoint()
            filtered_title_list = filterTitleListWithCoreTopicSet(title_list, getMetatopic[dog_or_cat_original]['static']) # could be enhabced with CLIP
                        ...
                        if len(bgm_list) > 3:
                            ...
                            for cover in cover_list:
                                ...
                                if cropped_image is not None:
                                    ...
                                    cv2.flip(cropped_image_color_transfered,)
