...
for _ in progressbar.progressbar(range(framesCount)):
    ...
    if success:
        ...
        np.sum(weighted_motion_vectors_filtered_cartesian_distance) = np.sum(weighted_motion_vectors_filtered_cartesian_distance)

        average_weighted_motion_vectors_filtered_cartesian_distance = /cartesianWeights
