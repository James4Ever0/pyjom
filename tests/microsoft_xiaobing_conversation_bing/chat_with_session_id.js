...
function i(n, i) {
  for (
    var s, c, e = 4, l = i.length / e - 1, r = [[], [], [], []], o = 0;
    o < 4 * e;
    o++
  )
  ...
  for (
    r = u(r, e), r = f(r, e), r = t(r, i, l, e), c = new Array(4 * e), o = 0;
    o < 4 * e;
    o++
  )
...
function rr(n) {
  ...
  for (t = r; t < o * (s + 1); t++) {
    ...
    if (t % r == 0) for (u = e(c(u)), i = 0; i < 4; i++) u[i] ^= l[t / r][i];
...
async function iceAI_word({
  ...
  let result = await getContents({
    ...
    headers: {
      ...
      referer:
        "https://cn.bing.com/search?q=123&form=QBLH&sp=-1&pq=123&sc=6-3&qs=n&sk=&cvid=566F001FDA424EEB805E1C175363B5AE",
      "user-agent":
...
async function newChatId(fromQQ) {
  var options = options || {};
  var httpOptions = {
    ...
    headers: {
      ...
      Referer:
        "referer: https://cn.bing.com/search?q=love&form=QBLHCN&sp=-1&pq=a&sc=6-1&qs=n&sk=&cvid=A91AB41228AD45E694D5F2EEBF87FE70",
