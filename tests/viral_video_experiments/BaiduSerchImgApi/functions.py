...
from config import ROOT_URL, HEADERS
...
class AiUtils(object):
    ...
    def get_api(self, image='', type='file'):
        ...
        if type == 'file':
            ...
            url_post = requests.post(url=ROOT_URL, files=files, headers=HEADERS,params=params)
        else:
            params['image'] = image
            data = {'image': image, }
            url_post = requests.post(url=ROOT_URL, data=data, headers=HEADERS,params=params)
    ...
    def get_wd(self, url):
        ...
        wd_str1 = wd_text.text.split(
            "<script>M.card.setData('c-guess-imglist', {ajaxImgUrl: 'https://graph.baidu.com/ajax/guesswordpic?")
    ...
    def get_tag(self, url):
        ...
        tag_str = tag_text.text.split(
            '<li class="graph-w-tag-item graph-c-similar-tag-item"data-url="https://graph.baidu.com/ajax/sims/?')
    ...
    def get_xiangshi(self, url, wd, tag, page=1):
        ...
        :param url:
        :return:
        str(result_url).replace('https://graph.baidu.com/s?sign=',
                                           'https://graph.baidu.com/ajax/sims/?sign=') + '&wd={}&entrance=&page=1&isNoPage=0'.format(
        wd)
        '''
        # if wd == '' and tag == '':
        #     return False
        if wd == '':
            wd = tag
        url_x = 'https://graph.baidu.com/s?sign='
        url_y = 'https://graph.baidu.com/ajax/sims/?sign='
    ...
    def get_miaodongbaike(self, wd, tag, sign):
        ...
        if wd == '':
            wd = tag
        url = "https://graph.baidu.com/ajax/imgfacelist?sign={sign}&wd={wd}&rn=15&page=0&type=pano&flag=0&tn=wise&baike_lemma_id=&locid=".format(
            sign=sign, wd=wd)
        print('bk', url)
    ...
    def get_image(self, sign, url):
        '''
        获取包含图片的相关信息的图集
        https://graph.baidu.com/view/same?sign=263967eca1ad40524540b01546507452&srcp=imageedit_card&tn=wise&idctag=tc&sids=10010_10125_10027_10003_10004_10103_10201_10040_10072_10062_10081_10191_10291_10391_10692_10703_10706_10301_10708_10802_10902_11006_10903_11003_9999&logid=1450353791&entrance=
        :return:
        '''
        # url = str(url).replace('https://graph.baidu.com/s?', 'https://graph.baidu.com/view/same?').replace(
        #     '&f=all&tn=wise&pageFrom=graph_upload_wise&idctag=tc&sids=',
        #     '&srcp=imageedit_card&tn=wise&idctag=tc&sids=') + '&entrance='
        # print(url, 'images')
        url = 'https://graph.baidu.com/view/same?sign={sign}&srcp=imageedit_card&tn=wise&idctag=tc&sids=10010_10125_10028_10003_10005_10104_10201_10040_10072_10062_10080_10190_10290_10390_10692_10704_10705_10301_10709_10802_10902_11006_10905_10911_11001&logid=1450353791&entrance='.format(
            sign=sign)
    ...
    def get_yanzhi(self, sign):
        ...
        :return:
        '''
        url = "https://graph.baidu.com/s?sign={sign}&wd=&f=face&srcp=&tn=wise&idctag=tc&sids=10010_10125_10028_10003_10005_10104_10201_10040_10072_10062_10080_10190_10290_10390_10692_10704_10705_10301_10709_10802_10902_11006_10905_10911_11001&logid=2121008205&entrance=&pageFrom=tool&ua=".format(
            sign=sign)
        print(url, '颜值')
...
if __name__ == "__main__":
    test_api = AiUtils()
    get_api = test_api.get_api(image='testimg/dm.jpeg', type='file') # image failed to upload.
    print("GET_API?",get_api)
