...
import jinja2
template_configs = {'defaultFontname':None,'defaultFontsize':None, 
"translationFontname":None, "translationFontsize":None,'kanjiFontname':None, 'kanjiFontsize':None, 'romajiFontname':None,'romajiFontsize':None}
