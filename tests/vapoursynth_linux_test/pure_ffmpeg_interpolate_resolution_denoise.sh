...
ffmpeg -i "/root/Desktop/works/pyjom/tests/random_giphy_gifs/samoyed.gif" -y -vf "sr=backend_dnn=tensorflow:model=./sr_models/dnn_models/espcn.model"  ffmpeg_samoyed_srcnn.mp4
