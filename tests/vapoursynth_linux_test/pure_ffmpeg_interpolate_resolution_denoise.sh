...
ffmpeg -y -i "/root/Desktop/works/pyjom/tests/random_giphy_gifs/samoyed.gif" -vf "sr=model=/root/Desktop/works/pyjom/tests/vapoursynth_linux_test/sr/espcn.pb" -r 60 ffmpeg_samoyed_srcnn.mp4
