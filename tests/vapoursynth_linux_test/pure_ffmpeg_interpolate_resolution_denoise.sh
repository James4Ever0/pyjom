ffmpeg -y -i "/root/Desktop/works/pyjom/tests/random_giphy_gifs/samoyed.gif" -vf "hqdn3d,scale=w=iw*2:h=ih*2:flags=lanczos,hqdn3d,minterpolate,hqdn3d" -r 60 ffmpeg_samoyed.mp4
