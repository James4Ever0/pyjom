...
ffmpeg -i "/root/Desktop/works/pyjom/samples/video/LiEIfnsvn.mp4" -flags2 +export_mvs -vf "fps=1,mestimate=epzs:mb_size=16:search_param=7,cropdetect=mode=mvedges,metadata=mode=print" -f null - # no printing?
