...
def getProxyList(port: int = 9911, debug=False, disallowed_types=[URLTest ]): # default do not return proxy groups. only standalone proxies.
    ...
    # pprint(proxyInfo)
    # breakpoint()
    for proxyName, proxy in proxyInfo['proxies'].:
