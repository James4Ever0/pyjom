...
declare type ProtectedPropertyContactMixin = 'contactRawPayload' | 'contactRawPayloadParser' | 'contactQueryFilterFactory' | 'contactPayloadCache';
declare type ContactMixin = ReturnType<typeof contactMixin>;
export type { ContactMixin, ProtectedPropertyContactMixin, };
export { contactMixin };
//# sourceMappingURL=contact-mixin.d.ts.map