...
declare type RoomInvitationMixin = ReturnType<typeof roomInvitationMixin>;
declare type ProtectedPropertyRoomInvitationMixin = 'roomInvitationPayloadCache' | 'roomInvitationRawPayload' | 'roomInvitationRawPayloadParser';
export type { RoomInvitationMixin, ProtectedPropertyRoomInvitationMixin, };
export { roomInvitationMixin };
//# sourceMappingURL=room-invitation-mixin.d.ts.map