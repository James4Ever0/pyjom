...
const mixinBase = FP.pipe(WechatySkeleton, gErrorMixin, wechatifyUserModuleMixin, ioMixin, serviceCtlMixin('Wechaty', { log }), pluginMixin, puppetMixin, loginMixin, miscMixin);
/**
