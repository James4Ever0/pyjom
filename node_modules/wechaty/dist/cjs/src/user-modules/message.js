...
const mini_program_js_1 = require("./mini-program.js");
...
class MessageMixin extends MixinBase {
    ...
    async mentionList() {
        ...
        if (this._payload
            ...
            const allContact = await Promise.all(this._payload.mentionIdList
                .map(idToContact));
    ...
    async toUrlLink() {
        ...
        return new url_link_js_1.UrlLinkImpl(urlPayload);
    }
    async toMiniProgram() {
        ...
        return new mini_program_js_1.MiniProgramImpl(miniProgramPayload);
    }
    async toLocation() {
