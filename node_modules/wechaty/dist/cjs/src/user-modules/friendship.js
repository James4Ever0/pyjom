...
const mod_js_1 = require("../pure-functions/mod.js");
...
class FriendshipMixin extends MixinBase {
    ...
    async accept() {
        ...
        wechaty_puppet_1.log.silly('Friendship', 'accept() to %s', this._payload.contactId);
...
class FriendshipImpl extends (0, validation_js_1.validationMixin)(FriendshipMixin)() {
}
exports.FriendshipImpl = FriendshipImpl;
