    ...
    class PuppetMixin extends mixinBase {
        ...
        async start() {
            ...
            try {
                ...
                wechaty_puppet_1.log.verbose('WechatyPuppetMixin', 'start() initializing puppet instance ...');
                await this.__initPuppetInstance();
                wechaty_puppet_1.log.verbose('WechatyPuppetMixin', 'start() initializing puppet instance ... done');
                try {
        ...
        async __initPuppetInstance() {
            wechaty_puppet_1.log.verbose('WechatyPuppetMixin', '__initPuppetInstance() %s', this.__options.puppet || '');
            if (this.__puppet) {
                wechaty_puppet_1.log.verbose('WechatyPuppetMixin', '__initPuppetInstance() initialized already: skip');
                return;
            }
            wechaty_puppet_1.log.verbose('WechatyPuppetMixin', '__initPuppetInstance() instanciating puppet instance ...');
            const puppet = this.__options.puppet || config_js_1.config.systemPuppetName();
            ...
            wechaty_puppet_1.log.verbose('WechatyPuppetMixin', '__initPuppetInstance() instanciating puppet instance ... done');
            /**
             * Plug the Memory Card to Puppet
             */
            wechaty_puppet_1.log.verbose('WechatyPuppetMixin', '__initPuppetInstance() setting memory ...');
            puppetInstance.setMemory(puppetMemory);
            wechaty_puppet_1.log.verbose('WechatyPuppetMixin', '__initPuppetInstance() setting memory ... done');
            this.__puppet = puppetInstance;
            wechaty_puppet_1.log.verbose('WechatyPuppetMixin', '__initPuppetInstance() setting up events ...');
            this.__setupPuppetEvents(puppetInstance);
            wechaty_puppet_1.log.verbose('WechatyPuppetMixin', '__initPuppetInstance() setting up events ... done');
            ...
            /**
              ...
              */
            wechaty_puppet_1.log.verbose('WechatyPuppetMixin', '__initPuppetInstance() emitting "puppet" event ...');
            this.emit('puppet', puppetInstance);
            wechaty_puppet_1.log.verbose('WechatyPuppetMixin', '__initPuppetInstance() emitting "puppet" event ... done');
        }
