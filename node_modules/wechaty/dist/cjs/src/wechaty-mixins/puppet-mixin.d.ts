...
declare const puppetMixin: <MixinBase extends ((abstract new (...args: any[]) => {
    ...
    use(...plugins: (import("../plugin.js").WechatyPlugin | import("../plugin.js").WechatyPlugin[])[]): import("./plugin-mixin.js").Plugable;
    ...
    readonly log: import("brolog/dist/esm/src/logger").Loggable;
    VERSION: string;
}) & typeof import("state-switch/dist/esm/src/service-ctl/service-ctl").ServiceCtl & ((abstract new (...args: any[]) => {
...
declare type ProtectedPropertyPuppetMixin = '__initPuppetInstance' | '__puppet' | '__readyState' | '__setupPuppetEvents';
