...
import type { FriendshipInterface, ContactSelfInterface, RoomInterface, RoomInvitationInterface, ContactInterface, MessageInterface } from '../user-modules/mod.js';
declare const WECHATY_EVENT_DICT: {
    ...
    readonly heartbeat: "Will be emitted periodically after the Wechaty started. If not, means that the Wechaty had died.";
    readonly puppet: "Will be emitted when the puppet has been set.";
    ...
    readonly 'room-invite': string;
    readonly 'room-join': string;
 ...
 */
declare type WechatyEventListenerDong = (data?: string) => void | Promise<void>;
declare type WechatyEventListenerError = (error: GError) => void | Promise<void>;
declare type WechatyEventListenerFriendship = (friendship: FriendshipInterface) => void | Promise<void>;
declare type WechatyEventListenerHeartbeat = (data: any) => void | Promise<void>;
declare type WechatyEventListenerLogin = (user: ContactSelfInterface) => void | Promise<void>;
declare type WechatyEventListenerLogout = (user: ContactSelfInterface, reason?: string) => void | Promise<void>;
declare type WechatyEventListenerMessage = (message: MessageInterface) => void | Promise<void>;
declare type WechatyEventListenerPuppet = (puppet: PUPPET.impls.PuppetInterface) => void | Promise<void>;
declare type WechatyEventListenerReady = () => void | Promise<void>;
declare type WechatyEventListenerRoomInvite = (roomInvitation: RoomInvitationInterface) => void | Promise<void>;
