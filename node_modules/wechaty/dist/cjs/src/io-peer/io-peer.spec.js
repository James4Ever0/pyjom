...
const io_peer_js_1 = require("./io-peer.js");
(0, tstest_1.test)('getPeer()', async (t) => {
    const EXPECTED_PORT = 8788;
    const server = (0, io_peer_js_1.getPeer)({
        serviceGrpcPort: EXPECTED_PORT,
    });
    const client = new json_rpc_peer_1.default.Peer();
    /**
...
(0, tstest_1.test)('exec()', async (t) => {
     ...
     *  See: https://github.com/wechaty/wechaty-puppet-service/issues/118
     */
    const request = json_rpc_peer_1.default.format.request(42, 'getHostieGrpcPort');
    const response = await server.exec(request);
    // console.info('response: ', response)
    const obj = json_rpc_peer_1.default.parse(response);
