...
declare type PostMixin = ReturnType<typeof postMixin>;
declare type ProtectedPropertyPostMixin = 'postPayloadCache' | 'postRawPayload' | 'postRawPayloadParser';
export type { PostMixin, ProtectedPropertyPostMixin, };
export { postMixin };
//# sourceMappingURL=post-mixin.d.ts.map