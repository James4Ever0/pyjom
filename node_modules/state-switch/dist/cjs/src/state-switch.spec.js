...
(0, tstest_1.test)('active()', async (t) => {
    const ss = new state_switch_js_1.StateSwitch();
...
(0, tstest_1.test)('inactive()', async (t) => {
    const ss = new state_switch_js_1.StateSwitch();
...
(0, tstest_1.test)('pending', async (t) => {
    const ss = new state_switch_js_1.StateSwitch();
...
(0, tstest_1.test)('name', async (t) => {
    ...
    const ss = new state_switch_js_1.StateSwitch(CLIENT_NAME);
...
(0, tstest_1.test)('stable()', async (t) => {
...
(0, tstest_1.test)('stable() without default arg for waiting current state', async (t) => {
    const spy = tstest_1.sinon.spy();
    const ss = new state_switch_js_1.StateSwitch();
    ss.inactive('pending');
...
(0, tstest_1.test)('active/inactive events emitting', async (t) => {
    const spyActive = tstest_1.sinon.spy();
    const spyInactive = tstest_1.sinon.spy();
    const ss = new state_switch_js_1.StateSwitch();
