    ...
    class ServiceCtlMixin extends superClass {
        ...
        async start() {
            ...
            if (this.state.inactive() === 'pending') {
                ...
                try {
                    await timeoutPromise(this.state.stable('inactive'), TIMEOUT_SECONDS * 1000);
        ...
        async stop() {
            ...
            if (this.state.active() === 'pending') {
                ...
                try {
                    ...
                    await timeoutPromise(this.state.stable('active'), TIMEOUT_SECONDS * 1000);
        ...
        async reset() {
            ...
            if (this.__serviceCtlResettingIndicator.busy()) {
                ...
                try {
                    await timeoutPromise(this.__serviceCtlResettingIndicator.idle(), RESET_TIMEOUT_SECONDS * 1000, () => new Error('wait resetting timeout'));
