...
class PuppetWeChatTest extends puppet_wechat_js_1.PuppetWeChat {
}
...
(0, tstest_1.test)('Room smoke testing', async (t) => {
    // Mock
    const mockContactRoomRawPayload = (id) => {
        config_js_1.log.verbose('PuppeteerRoomTest', 'mockContactRawPayload(%s)', id);
