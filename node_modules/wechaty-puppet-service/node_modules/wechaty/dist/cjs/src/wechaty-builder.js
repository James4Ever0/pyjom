...
const mod_js_1 = require("./wechaty/mod.js");
class WechatyBuilder {
    static _instance;
    static valid(target) {
        return mod_js_1.WechatyImpl.valid(target);
    }
    /**
    ...
    _options = {};
    singleton() {
        wechaty_puppet_1.log.verbose('WechatyBuilder', 'singleton()');
    ...
    singletonInstance() {
        wechaty_puppet_1.log.verbose('WechatyBuilder', 'singletonInstance()');
    ...
    newInstance() {
        wechaty_puppet_1.log.verbose('WechatyBuilder', 'newInstance()');
        return new mod_js_1.WechatyImpl(this._options);
    }
}
exports.WechatyBuilder = WechatyBuilder;
//# sourceMappingURL=wechaty-builder.js.map