...
exports.WECHATY_PUPPET_SERVICE_AUTHORITY = exports.WECHATY_PUPPET_SERVICE_TOKEN = exports.WECHATY_PUPPET_SERVICE_ENDPOINT = void 0;
const wechaty_puppet_1 = require("wechaty-puppet");
// Huan(202011): use a function to return the value in time.
const WECHATY_PUPPET_SERVICE_TOKEN = token => {
    if (token) {
        return token;
    }
...
exports.WECHATY_PUPPET_SERVICE_TOKEN = WECHATY_PUPPET_SERVICE_TOKEN;
const WECHATY_PUPPET_SERVICE_ENDPOINT = (endpoint) => {
    if (endpoint) {
        return endpoint;
    }
...
exports.WECHATY_PUPPET_SERVICE_ENDPOINT = WECHATY_PUPPET_SERVICE_ENDPOINT;
const WECHATY_PUPPET_SERVICE_AUTHORITY = (authority) => {
    if (authority) {
        return authority;
    }
...
exports.WECHATY_PUPPET_SERVICE_AUTHORITY = WECHATY_PUPPET_SERVICE_AUTHORITY;
