...
import { grpc, puppet, } from '../src/mod.js';
...
test('use StringValue to support nullable values', async (t) => {
    ...
    server.addService(puppet.PuppetService, puppetServerImplTest);
    try {
        ...
        const port = await util.promisify(server.bindAsync.bind(server))(SERVER_ENDPOINT, grpc.ServerCredentials.createInsecure());
    ...
    server.start();
    const client = new puppet.PuppetClient(SERVER_ENDPOINT, grpc.credentials.createInsecure());
