...
####################
        ...
        if result is not None:
            ...
            debugInfo = None
####################
        return {'duplicatePercent':dupPercent, 'frameDuplicatePercent':frameDupPercent,'effectiveFPS':effectiveFPS, 'dframes2':dframes2, debugInfo # time ranges of duplicated frames
