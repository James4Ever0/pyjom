...
def getVideoColorCentrality(videoPath,
    ...
    centrality_threshold=,# for early return.
    mean_centrality_threshold=,
    ...
    return {"centrality":{"max":max_centrality,"mean":mean_centrality}, "max_nearby_center_percentage":{'max':max_max_nearby_center_percentage, 'mean':mean_max_nearby_center_percentage}}
