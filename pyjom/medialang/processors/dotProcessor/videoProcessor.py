                ...
                for prefix, keyword in [
                    ...
                    if renderCommand.startswith(prefix):
                        ...
                        if keyword == "delogo":
                            ...
                            # TODO: the main shit happens here is that if pip region is detected, it will not maintain the width to height ratio. you might need padding, but that's another story.
