...
def ffmpegVideoPreProductionFilter(filepath, start=None, end=None, cachePath=None, filters=["pipCrop","textRemoval","logoDetection"]): # what is the type of this shit?
                ...
                for layerElem in elem:
                    ...
                    if layerElemItem.args.get("backend","editly") == "editly":
                        if filetype == "video":
                            ...
                            processedFilePath, processed= ffmpegVideoPreProductionFilter(filepath, start=cutFrom, end=cutTo, cachePath=cachePath)
