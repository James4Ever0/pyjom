...
@decorator
def OnlineFetcher(infoList, source:Literal['giphy']='giphy', frame_size_filter:dict={'width':{'min':150,'max':1000}, 'height':{'min':150,'max':1000}}, tempdir='/dev/shm/medialang/online'):
