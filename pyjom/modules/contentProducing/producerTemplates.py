...
def getMusicCutSpansGaussian(music, music_duration,lyric_path, mintime=0.6, maxtime=7.833, mbeat_time_tolerance=0.8, std = 1.6674874515595588,mean =  2.839698412698412):
    ...
    while True:
        ...
        doubleRate = min(2, standard_bpm_span_min_selected)
...
def renderList2MediaLang(
    renderList, slient=True, bgm=None, backend="ffmpeg"  # wtf is this ffmpeg?
):  # this is just a primitive. need to improve in many ways.
    # producer = ""
    scriptBase = [
        '(".mp4",backend = "%s", bgm = "%s")' % (backend, bgm)
