...
const reduce_reducers_from_map_object_js_1 = require("./reduce-reducers-from-map-object.js");
tstest_1.test.skip('DEPRECATED: reduceReducersFromMapObject()', async (t) => {
    const reducer = (0, reduce_reducers_from_map_object_js_1.reduceReducersFromMapObject)({
...
//# sourceMappingURL=reduce-reducers-from-map-object.spec.js.map