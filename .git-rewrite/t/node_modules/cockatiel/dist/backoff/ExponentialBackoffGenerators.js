 ...
 */
exports.noJitterGenerator = (attempts = 0, options) => [
 ...
 */
exports.fullJitterGenerator = (state, options) => {
    const [delay, next] = exports.noJitterGenerator(state, options);
    return [Math.floor(Math.random() * delay), next];
};
/**
 * Generator that randomizes an exponential backoff between [0, delay).
 */
exports.halfJitterGenerator = (attempts, options) => {
    const [delay, next] = exports.noJitterGenerator(attempts, options);
 ...
 */
exports.decorrelatedJitterGenerator = (state, options) => {
