...
describe('SamplingBreaker', () => {
    describe('parameter creation', () => {
        ...
        it('creates good initial params', () => {
            const b = new SamplingBreaker({ threshold: 0.2, duration: 10000, minimumRps: 5 });
    ...
    describe('windowing', () => {
        ...
        let clock;
        beforeEach(() => {
            b = new SamplingBreaker({ threshold: 0.5, duration: 5000, minimumRps: 3 });
            clock = useFakeTimers();
        });
        afterEach(() => {
            clock.restore();
    ...
    describe('functionality', () => {
        let b;
        let clock;
        const createTestBreaker = () => (b = new SamplingBreaker({ threshold: 0.5, duration: 5000, minimumRps: 3 }));
        beforeEach(() => {
            createTestBreaker();
            clock = useFakeTimers();
        });
