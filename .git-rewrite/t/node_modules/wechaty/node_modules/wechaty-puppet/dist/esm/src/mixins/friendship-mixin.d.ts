...
declare const friendshipMixin: <MixinBase extends typeof PuppetSkeleton & (abstract new (...args: any[]) => {
    ...
    friendshipAdd(contactId: string, option?: FriendshipAddOptions | undefined): Promise<void>;
...
declare type FriendshipMixin = ReturnType<typeof friendshipMixin>;
declare type ProtectedPropertyFriendshipMixin = 'friendshipRawPayload' | 'friendshipRawPayloadParser' | 'friendshipPayloadCache';
export type { FriendshipMixin, ProtectedPropertyFriendshipMixin, };
export { friendshipMixin };
//# sourceMappingURL=friendship-mixin.d.ts.map