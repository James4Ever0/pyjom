...
declare const MixinBase: ((abstract new (...args: any[]) => {
    ...
    readyIndicator: import("state-switch/dist/esm/src/boolean-indicator").BooleanIndicator;
    start(): Promise<void>;
    stop(): Promise<void>;
    readonly id: string;
    readonly options: PuppetOptions;
    ...
    setMaxListeners(maxListeners: number): any;
    __events: import("./events.js").PuppetEventListener;
    _memory: import("memory-card/dist/esm/src/memory-card").MemoryCard;
    readonly memory: import("memory-card/dist/esm/src/memory-card").MemoryCard;
    setMemory(memory: import("memory-card/dist/esm/src/memory-card").MemoryCard): void;
}) & (abstract new (...args: any[]) => {
    ...
    messageFile(messageId: string): Promise<import("file-box/dist/esm/src/interface").FileBoxInterface>;
    messageImage(messageId: string, imageType: import("../schemas/image.js").ImageType): Promise<import("file-box/dist/esm/src/interface").FileBoxInterface>;
    ...
    messageSendFile(conversationId: string, file: import("file-box/dist/esm/src/interface").FileBoxInterface): Promise<string | void>;
    ...
    dirtyPayload(type: import("../schemas/payload.js").PayloadType, id: string): void;
    onDirty({ payloadType, payloadId, }: import("../schemas/event.js").EventDirtyPayload): void;
    __dirtyPayloadAwait(type: import("../schemas/payload.js").PayloadType, id: string): Promise<void>;
    ...
    roomAvatar(roomId: string): Promise<import("file-box/dist/esm/src/interface").FileBoxInterface>;
    ...
    contactAvatar(contactId: string): Promise<import("file-box/dist/esm/src/interface").FileBoxInterface>;
    contactAvatar(contactId: string, file: import("file-box/dist/esm/src/interface").FileBoxInterface): Promise<void>;
