...
declare const roomMemberMixin: <MixinBase extends typeof PuppetSkeleton & (abstract new (...args: any[]) => {
    ...
    dirtyPayload(type: PayloadType, id: string): void;
    onDirty({ payloadType, payloadId, }: import("../schemas/event.js").EventDirtyPayload): void;
    __dirtyPayloadAwait(type: PayloadType, id: string): Promise<void>;
    readonly id: string;
    ...
    roomMemberSearch(roomId: string, query: (symbol | string) | RoomMemberQueryFilter): Promise<string[]>;
...
declare type RoomMemberMixin = ReturnType<typeof roomMemberMixin>;
declare type ProtectedPropertyRoomMemberMixin = 'roomMemberRawPayload' | 'roomMemberRawPayloadParser';
export type { ProtectedPropertyRoomMemberMixin, RoomMemberMixin, };
export { roomMemberMixin };
//# sourceMappingURL=room-member-mixin.d.ts.map