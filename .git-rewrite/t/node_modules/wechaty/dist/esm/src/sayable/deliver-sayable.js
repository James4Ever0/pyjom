...
import { ContactImpl, MessageImpl, DelayImpl, UrlLinkImpl, MiniProgramImpl, LocationImpl, } from '../user-modules/mod.js';
/**
...
const deliverSayableConversationPuppet = (puppet) => (conversationId) => async (sayable) => {
    ...
    if (!(sayable instanceof Object)) {
        ...
        msgId = await puppet.messageSendText(conversationId, sayable);
        return msgId;
    }
    /**
