...
class MessageMixin extends MixinBase {
    ...
    self() {
        try {
            ...
            this.wechaty.emitError(e);
            log.error('Message', 'self() rejection: %s', e.message);
            return false;
        }
    }
    /**
    ...
    async mentionList() {
        ...
        log.verbose('Message', 'mentionList() text = "%s", mentionNameList = "%s"', this.text(), JSON.stringify(mentionNameList));
...
class MessageImplBase extends validationMixin(MessageMixin)() {
}
class MessageImpl extends validationMixin(MessageImplBase)() {
}
export { MessageImpl, };
