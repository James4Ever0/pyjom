    ...
    class PuppetMixin extends mixinBase {
        ...
        async start() {
            ...
            try {
                ...
                try {
                    ...
                    await timeoutPromise(this.puppet.start(), 15 * 1000);
        ...
        async stop() {
            ...
            try {
                ...
                await timeoutPromise(this.puppet.stop(), 15 * 1000);
        ...
        __setupPuppetEvents(puppet) {
            ...
            for (const eventName of eventNameList) {
                log.verbose('PuppetMixin', '__setupPuppetEvents() puppet.on(%s) (listenerCount:%s) registering...', eventName, puppet.listenerCount(eventName));
                switch (eventName) {
                    case 'dong':
                        ...
                        puppet.on('logout', async (payload) => {
                            try {
                                ...
                                if (contact) {
                                    ...
                                    log.verbose('PuppetMixin', '__setupPuppetEvents() logout event contact self not found for id: %s', payload.contactId);
                                }
                            }
                            catch (e) {
                                this.emit('error', GError.from(e));
