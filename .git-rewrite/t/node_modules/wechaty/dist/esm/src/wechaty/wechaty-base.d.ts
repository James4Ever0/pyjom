...
declare const mixinBase: ((abstract new (...args: any[]) => {
    ...
    start: (() => Promise<void>) & (() => Promise<void>) & (() => Promise<void>) & (() => Promise<void>) & (() => Promise<void>) & ((..._: any[]) => any) & (() => Promise<void>);
    stop: (() => Promise<void>) & (() => Promise<void>) & (() => Promise<void>) & (() => Promise<void>) & ((..._: any[]) => any) & (() => Promise<void>);
    ...
    emit: (<E_7 extends keyof import("../schemas/wechaty-events.js").WechatyEventListeners>(event: E_7, ...args: import("typed-emitter").Arguments<import("../schemas/wechaty-events.js").WechatyEventListeners[E_7]>) => boolean) & ((event: any, ...args: any) => boolean) & ((..._: any[]) => any) & ((..._: any[]) => any);
    ...
    __puppet?: import("wechaty-puppet/dist/esm/src/puppet/puppet-interface").PuppetInterface | undefined;
    readonly puppet: import("wechaty-puppet/dist/esm/src/puppet/puppet-interface").PuppetInterface;
    readonly __readyState: import("state-switch/dist/esm/src/interfaces").StateSwitchInterface;
    ready(): Promise<void>;
    __initPuppetInstance(): Promise<void>;
    __setupPuppetEvents(puppet: import("wechaty-puppet/dist/esm/src/puppet/puppet-interface").PuppetInterface): void;
    ...
    __pluginList: import("../plugin.js").WechatyPlugin[];
    __pluginUninstallerList: import("../plugin.js").WechatyPluginUninstaller[];
    use(...plugins: (import("../plugin.js").WechatyPlugin | import("../plugin.js").WechatyPlugin[])[]): import("../wechaty-mixins/plugin-mixin.js").Plugable;
    __activePlugin(pluginList: import("../plugin.js").WechatyPlugin[]): void;
