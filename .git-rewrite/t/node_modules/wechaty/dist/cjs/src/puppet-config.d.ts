 ...
 *
 */
declare const PUPPET_DEPENDENCIES: {
    /**
...
declare type PuppetModuleName = keyof typeof PUPPET_DEPENDENCIES;
/**
 * Updates:
 ...
 */
declare const PUPPET_NAME_DEFAULT: PuppetModuleName;
export type { PuppetModuleName, };
export { PUPPET_DEPENDENCIES, PUPPET_NAME_DEFAULT, };
