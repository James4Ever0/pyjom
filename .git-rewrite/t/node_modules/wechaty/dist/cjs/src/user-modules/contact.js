...
class ContactMixin extends MixinBase {
    ...
    static async find(query) {
        config_js_1.log.silly('Contact', 'find(%s)', JSON.stringify(query));
    ...
    static async findAll(query) {
        config_js_1.log.verbose('Contact', 'findAll(%s)', JSON.stringify(query) || '');
        try {
    ...
    async alias(newAlias) {
        ...
        try {
            ...
            if (newAlias && newAlias !== this._payload.alias) {
                config_js_1.log.warn('Contact', 'alias(%s) sync with server fail: set(%s) is not equal to get(%s)', newAlias, newAlias, this._payload.alias);
            }
        }
        catch (e) {
            this.wechaty.emitError(e);
