...
class RoomMixin extends MixinBase {
    ...
    static async findAll(query) {
        config_js_1.log.verbose('Room', 'findAll(%s)', JSON.stringify(query) || '');
        try {
            const roomIdList = await this.wechaty.puppet.roomSearch(query);
            const idToRoom = async (id) => this.wechaty.Room.find({ id }).catch(e => this.wechaty.emitError(e));
            /**
    ...
    static async find(query) {
        config_js_1.log.silly('Room', 'find(%s)', JSON.stringify(query));
