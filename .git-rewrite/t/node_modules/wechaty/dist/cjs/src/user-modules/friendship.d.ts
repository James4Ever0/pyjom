...
declare class FriendshipMixin extends MixinBase implements Accepter {
     ...
     *
     */
    static search(queryFilter: PUPPET.filters.Friendship): Promise<undefined | ContactInterface>;
    /**
     ...
     *
     */
    static add(contact: ContactInterface, options: FriendshipAddOptions): Promise<void>;
    static del(contact: ContactInterface): Promise<void>;
    /**
     *
     * Instance Properties
     *
     ...
     * await friendship.accept()
     */
    static fromJSON(payload: string | PUPPET.payloads.Friendship): Promise<FriendshipInterface>;
}
...
declare type FriendshipConstructor = Constructor<FriendshipInterface, typeof FriendshipImpl>;
