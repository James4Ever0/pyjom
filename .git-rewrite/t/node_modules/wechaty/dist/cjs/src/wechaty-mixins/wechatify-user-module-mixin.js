...
const wechatifyUserModuleMixin = (mixinBase) => {
    ...
    class WechatifyUserModuleMixin extends mixinBase {
        ...
        async start() {
            wechaty_puppet_1.log.verbose('WechatifyUserModuleMixin', 'start()');
            await super.start();
            this.__wechatifyUserModules();
        }
        __wechatifyUserModules() {
            wechaty_puppet_1.log.verbose('WechatifyUserModuleMixin', '_wechatifyUserModules()');
            /**
             * Skip if already wechatified
             */
            if (this.__wechatifiedMessage) {
                wechaty_puppet_1.log.verbose('WechatifyUserModuleMixin', '_wechatifyUserModules() Wechaty User Module (WUM)s have already wechatified: skip');
                return;
            }
            wechaty_puppet_1.log.verbose('WechatifyUserModuleMixin', '_wechatifyUserModules() initializing Wechaty User Module (WUM) ...');
            /**
            ...
            wechaty_puppet_1.log.verbose('WechatifyUserModuleMixin', '_wechatifyUserModules() initializing Wechaty User Module (WUM) ... done');
        }
    }
