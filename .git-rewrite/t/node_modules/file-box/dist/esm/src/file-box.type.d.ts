...
declare type FileBoxOptions = FileBoxOptionsCommon & (never | FileBoxOptionsBase64 | FileBoxOptionsBuffer | FileBoxOptionsFile | FileBoxOptionsQRCode | FileBoxOptionsStream | FileBoxOptionsUrl | FileBoxOptionsUuid);
declare type FileBoxJsonObject = FileBoxOptionsCommon & (FileBoxOptionsBase64 | FileBoxOptionsUrl | FileBoxOptionsQRCode | FileBoxOptionsUuid);
declare type UuidLoader = (this: FileBox, uuid: string) => Promise<Readable>;
declare type UuidSaver = (this: FileBox, stream: Readable) => Promise<string>;
export type { FileBoxJsonObject, FileBoxOptions, FileBoxOptionsBase64, FileBoxOptionsCommon, FileBoxOptionsQRCode, FileBoxOptionsUrl, FileBoxOptionsUuid, Metadata, Pipeable, UuidSaver, UuidLoader, };
export { FileBoxType, };
