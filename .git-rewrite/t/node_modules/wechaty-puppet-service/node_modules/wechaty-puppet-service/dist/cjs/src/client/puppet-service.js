...
class PuppetService extends PUPPET.Puppet {
    ...
    async roomAnnounce(roomId, text) {
        config_js_1.log.verbose('PuppetService', 'roomAnnounce(%s%s)', roomId, typeof text === 'undefined'
            ? ''
            : `, ${text}`);
        /**
         * Set
        ...
        if (text) {
            ...
            await util_1.default.promisify(this.grpcManager.client.roomAnnounce
                .bind(this.grpcManager.client))(request);
            return;
        }
        /**
        ...
        const request = new wechaty_grpc_1.puppet.RoomAnnounceRequest();
        request.setId(roomId);
        const response = await util_1.default.promisify(this.grpcManager.client.roomAnnounce
            .bind(this.grpcManager.client))(request);
    ...
    async roomInvitationAccept(roomInvitationId) {
        config_js_1.log.verbose('PuppetService', 'roomInvitationAccept(%s)', roomInvitationId);
    ...
    async roomInvitationRawPayload(id) {
        config_js_1.log.verbose('PuppetService', 'roomInvitationRawPayload(%s)', id);
    ...
    async friendshipSearchPhone(phone) {
        config_js_1.log.verbose('PuppetService', 'friendshipSearchPhone(%s)', phone);
        const request = new wechaty_grpc_1.puppet.FriendshipSearchPhoneRequest();
        request.setPhone(phone);
        const response = await util_1.default.promisify(this.grpcManager.client.friendshipSearchPhone
            .bind(this.grpcManager.client))(request);
    ...
    async friendshipSearchHandle(handle) {
        config_js_1.log.verbose('PuppetService', 'friendshipSearchHandle(%s)', handle);
        ...
        const response = await util_1.default.promisify(this.grpcManager.client.friendshipSearchHandle
            .bind(this.grpcManager.client))(request);
        const contactId = response.getContactId();
        if (contactId) {
            return contactId;
    ...
    async friendshipRawPayload(id) {
        config_js_1.log.verbose('PuppetService', 'friendshipRawPayload(%s)', id);
    ...
    async friendshipAdd(contactId, options) {
        config_js_1.log.verbose('PuppetService', 'friendshipAdd(%s, %s)', contactId, JSON.stringify(options));
        ...
        if (typeof options === 'string') {
            ...
            const referrer = new wechaty_grpc_1.puppet.Referrer();
        ...
        await util_1.default.promisify(this.grpcManager.client.friendshipAdd
            .bind(this.grpcManager.client))(request);
    }
    async friendshipAccept(friendshipId) {
        config_js_1.log.verbose('PuppetService', 'friendshipAccept(%s)', friendshipId);
    ...
    async tagContactAdd(id, contactId) {
        config_js_1.log.verbose('PuppetService', 'tagContactAdd(%s, %s)', id, contactId);
        const request = new wechaty_grpc_1.puppet.TagContactAddRequest();
        request.setId(id);
        request.setContactId(contactId);
        await util_1.default.promisify(this.grpcManager.client.tagContactAdd
            .bind(this.grpcManager.client))(request);
    }
    // remove a tag from the Contact
    async tagContactRemove(id, contactId) {
        config_js_1.log.verbose('PuppetService', 'tagContactRemove(%s, %s)', id, contactId);
        const request = new wechaty_grpc_1.puppet.TagContactRemoveRequest();
        request.setId(id);
        request.setContactId(contactId);
        await util_1.default.promisify(this.grpcManager.client.tagContactRemove
            .bind(this.grpcManager.client))(request);
    }
    // delete a tag from Wechat
    async tagContactDelete(id) {
        config_js_1.log.verbose('PuppetService', 'tagContactDelete(%s)', id);
