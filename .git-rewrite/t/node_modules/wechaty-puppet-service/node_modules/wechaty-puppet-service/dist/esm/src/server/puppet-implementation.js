import { chunkDecoder, chunkEncoder, StringValue, grpc, puppet as grpcPuppet, } from 'wechaty-grpc';
import * as PUPPET from 'wechaty-puppet';
import { timeoutPromise } from 'gerror';
import { packFileBoxToPb, unpackConversationIdFileBoxArgsFromPb, } from '../deprecated/mod.js';
    ...
    const puppetServerImpl = {
        ...
        messageImageStream: async (call) => {
            ...
            try {
                ...
                log.error('PuppetServiceImpl', 'grpcError() messageImageStream() rejection: %s', e.message);
                call.destroy(e);
            }
        },
        ...
        start: async (call, callback) => {
            ...
            void call;
            try {
                await timeoutPromise(puppet.start(), 15 * 1000);
        ...
        stop: async (call, callback) => {
            ...
            try {
                ...
                readyPayload = undefined;
                await timeoutPromise(puppet.stop(), 15 * 1000);
        ...
        upload: async (call, callback) => {
            ...
            const fileBox = FileBoxUuid.fromStream(call.pipe(chunkDecoder()), 'uuid.dat');
