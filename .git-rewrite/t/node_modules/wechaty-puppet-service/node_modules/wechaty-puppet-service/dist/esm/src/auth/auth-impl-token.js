...
import { StatusBuilder, Metadata, GrpcStatus, } from './grpc-js.js';
...
const authWrapHandlerToken = (validToken) => (handler) => {
    log.verbose('wechaty-puppet-service', 'auth/auth-impl-token.ts authWrapHandlerToken(%s)(%s)', validToken, handler.name);
