...
test('integration testing', async (t) => {
    ...
    server.addService(puppet.PuppetService, testServer);
    await util.promisify(server.bindAsync.bind(server))(ENDPOINT, grpc.ServerCredentials.createInsecure());
    server.start();
    /**
     * Create Client
     */
    const client = new puppet.PuppetClient(ENDPOINT, grpc.credentials.createInsecure());
    /**
     * gRPC: Stream
     */
