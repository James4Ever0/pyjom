...
import type { TcpSubchannelAddress } from '@grpc/grpc-js/build/src/subchannel-address.js';
import { parseUri, uriToString, type GrpcUri } from '@grpc/grpc-js/build/src/uri-parser.js';
...
export { BackoffTimeout, ChannelOptions, GrpcStatus, type GrpcUri, Metadata, parseUri, resolverManager, ServiceConfig, StatusObject, TcpSubchannelAddress, uriToString, };
