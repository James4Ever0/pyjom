...
class PuppetWechat4u extends PUPPET.Puppet {
    ...
    initHookEvents(wechat4u) {
        ...
        wechat4u.on('message', (msg) => {
            ...
            switch (msg.MsgType) {
                case web_schemas_js_1.WebMessageType.STATUSNOTIFY:
    ...
    async contactAvatar(contactId, file) {
         ...
         * 如何获取联系人头像
         */
        return file_box_1.FileBox.fromStream(res.data, `wechaty-contact-avatar-${name}.jpg`);
    }
    async contactRawPayload(contactId) {
        ...
        if (!(contactId in this.wechat4u.contacts)) {
            try {
                ...
                wechaty_puppet_1.log.silly('PuppetWechat4u', 'contactRawPayload(%s) wechat4u.batchGetContact() result: %s', JSON.stringify(result));
    ...
    async messageFile(id) {
        ...
        switch (rawPayload.MsgType) {
            ...
            case this.wechat4u.CONF.MSGTYPE_VOICE:
                ...
                return file_box_1.FileBox.fromStream((await this.wechat4u.getVoice(rawPayload.MsgId)).data, filename);
            ...
            case this.wechat4u.CONF.MSGTYPE_MICROVIDEO:
                ...
                return file_box_1.FileBox.fromStream((await this.wechat4u.getVideo(rawPayload.MsgId)).data, filename);
            case this.wechat4u.CONF.MSGTYPE_APP:
                if (rawPayload.AppMsgType === 6) {
                    ...
                    return file_box_1.FileBox.fromStream((await this.wechat4u.getDoc(rawPayload.FromUserName, rawPayload.MediaId, rawPayload.FileName)).data, filename);
                }
                break;
            default:
                break;
