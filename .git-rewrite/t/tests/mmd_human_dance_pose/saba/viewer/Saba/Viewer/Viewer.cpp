...
namespace saba
{
	...
	bool Viewer::CmdRecord(const std::vector<std::string>& args)
	{
		// most likely will record something?
		return true;
	}
	bool Viewer::CmdSleep(const std::vector<std::string>& args)
	{
		// will it allow us to sleep?
		return true;
	}
