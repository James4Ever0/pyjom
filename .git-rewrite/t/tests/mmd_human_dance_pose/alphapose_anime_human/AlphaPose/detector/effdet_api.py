...
class EffDetDetector(BaseDetector):
    ...
    def load_model(self):
        ...
        # print("EfficientDet model config and weights",self.model_cfg,self.model_weights)
        # breakpoint()
    ...
    def images_detection(self, imgs, orig_dim_list):
        ...
        with torch.no_grad():
            ...
            write = False
            # efficient net detect human.
            # we either retrain this shit or do something else.
