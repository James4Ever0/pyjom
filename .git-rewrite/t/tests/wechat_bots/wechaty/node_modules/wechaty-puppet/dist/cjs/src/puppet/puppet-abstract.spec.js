...
const contact_js_1 = require("../schemas/contact.js");
const message_js_1 = require("../schemas/message.js");
const puppet_skeleton_js_1 = require("./puppet-skeleton.js");
/**
 * The Fixture
 */
const puppet_test_js_1 = require("../../tests/fixtures/puppet-test/puppet-test.js");
(0, tstest_1.test)('contactQueryFilterFunction()', async (t) => {
    ...
    const PAYLOAD_LIST = [
        {
            alias: TEXT_TEXT,
            avatar: 'mock',
            gender: contact_js_1.ContactGender.Unknown,
            id: 'id1',
            name: TEXT_REGEX,
            phone: [],
            type: contact_js_1.ContactType.Individual,
        },
        {
            alias: TEXT_REGEX,
            avatar: 'mock',
...
(0, tstest_1.test)('roomQueryFilterFunction()', async (t) => {
    const TEXT_REGEX = 'query by regex';
    const TEXT_TEXT = 'query by text';
    const PAYLOAD_LIST = [
        {
 ...
 */
tstest_1.test.skip('reset event throttle for reset()', async (t) => {
    const puppet = new puppet_test_js_1.PuppetTest({});
...
(0, tstest_1.test)('set memory() memory with a name', async (t) => {
    const puppet = new puppet_test_js_1.PuppetTest();
    const memory = new config_js_1.MemoryCard({ name: 'name' });
...
(0, tstest_1.test)('messageQueryFilterFactory() one condition', async (t) => {
...
(0, tstest_1.test)('messageQueryFilterFactory() two condition', async (t) => {
    const EXPECTED_TEXT_DATA = 'data';
    const EXPECTED_TEXT_LINK = 'https://google.com';
    const EXPECTED_TYPE_URL = message_js_1.MessageType.Url;
    const EXPECTED_TYPE_TEXT = message_js_1.MessageType.Text;
    const QUERY_TEXT = {
    ...
    const PAYLOAD_LIST = [
        ...
        {
            text: EXPECTED_TEXT_DATA,
            type: message_js_1.MessageType.Url,
        },
        {
...
(0, tstest_1.test)('PuppetSkeleton: super.{start,stop}()', async (t) => {
    const sandbox = tstest_1.sinon.createSandbox();
    const startStub = sandbox.stub(puppet_skeleton_js_1.PuppetSkeleton.prototype, 'start').resolves();
    const stopStub = sandbox.stub(puppet_skeleton_js_1.PuppetSkeleton.prototype, 'stop').resolves();
    const puppet = new puppet_test_js_1.PuppetTest();
...
//# sourceMappingURL=puppet-abstract.spec.js.map