...
(0, tstest_1.test)('AsyncMapLike Interface via object', async (t) => {
    const mapCollection = {
        clear: async () => { },
...
(0, tstest_1.test)('AsyncMapLike Interface via class', async (t) => {
...
(0, tstest_1.test)('AsyncMapLike Interface via class generic', async (t) => {
    class TestAsyncMapLike {
        constructor() { }
        /**
         * Collections
