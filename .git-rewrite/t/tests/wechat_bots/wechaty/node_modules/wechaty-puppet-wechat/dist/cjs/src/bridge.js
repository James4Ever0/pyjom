...
class Bridge extends events_1.EventEmitter {
    ...
    constructor(options) {
        ...
        this.state = new state_switch_1.StateSwitch('PuppetWeChatBridge', { log: wechaty_puppet_1.log });
    }
    async start() {
        ...
        try {
            ...
            wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'start() initBrowser() done');
            ...
            wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'start() initPage() done');
        }
        catch (e) {
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'start() exception: %s', e);
            ...
            try {
                ...
                wechaty_puppet_1.log.error('PuppetWeChatBridge', 'start() exception %s, close page/browser exception %s', e, e2);
            }
            this.emit('error', e);
            throw e;
        }
    ...
    async initBrowser() {
        ...
        wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'initBrowser() version: %s', version);
        return browser;
    }
    async onDialog(dialog) {
        wechaty_puppet_1.log.warn('PuppetWeChatBridge', 'onDialog() page.on(dialog) type:%s message:%s', dialog.type, dialog.message());
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'onDialog() dialog.dismiss() reject: %s', e);
        }
        this.emit('error', gerror_1.GError.from(`${dialog.type}(${dialog.message()})`));
    }
    async onLoad(page) {
        wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'onLoad() page.url=%s', page.url());
        if (this.state.inactive()) {
            wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'onLoad() OFF state detected. NOP');
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'onLoad() exception: %s', e);
            await page.close();
            this.emit('error', e);
        }
    }
    async initPage(browser) {
        ...
        const cookieList = (await this.options.memory.get(config_js_1.MEMORY_SLOT)) || [];
        const url = this.entryUrl(cookieList);
        wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'initPage() before page.goto(url)');
        // Does this related to(?) the CI Error: exception: Navigation Timeout Exceeded: 30000ms exceeded
        await page.goto(url);
        wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'initPage() after page.goto(url)');
        // await this.uosPatch(page)
        void this.uosPatch;
        if (cookieList.length) {
            await page.setCookie(...cookieList);
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'initPage() page.setCookie() %s cookies set back', cookieList.length);
        }
    ...
    async readyAngular(page) {
        ...
        try {
            ...
            wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'readyAngular() exception: %s', e);
            ...
            if (blockedMessage) { // Wechat Account Blocked
                ...
                wechaty_puppet_1.log.info('PuppetWeChatBridge', `
    ...
    async inject(page) {
        ...
        const WECHATY_BRO_JS_FILE = path_1.default.join(cjs_js_1.codeRoot, 'src', 'wechaty-bro.js');
        try {
            ...
            if (retObj && /^(2|3)/.test(retObj.code.toString())) {
                // HTTP Code 2XX & 3XX
                wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'inject() eval(Wechaty) return code[%d] message[%s]', retObj.code, retObj.message);
            }
            ...
            if (retObj && /^(2|3)/.test(retObj.code.toString())) {
                // HTTP Code 2XX & 3XX
                wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'inject() Wechaty.init() return code[%d] message[%s]', retObj.code, retObj.message);
            }
            else { // HTTP Code 4XX & 5XX
            ...
            wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'inject() exception: %s. stack: %s', e.message, e.stack);
            throw e;
        }
    }
    async logout() {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'logout() exception: %s', e.message);
            throw e;
        }
    }
    async stop() {
        ...
        try {
            await this.page.close();
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'stop() page.close()-ed');
        }
        catch (e) {
            wechaty_puppet_1.log.warn('PuppetWeChatBridge', 'stop() page.close() exception: %s', e);
        }
        try {
            await this.browser.close();
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'stop() browser.close()-ed');
        }
        catch (e) {
            wechaty_puppet_1.log.warn('PuppetWeChatBridge', 'stop() browser.close() exception: %s', e);
        }
        this.state.inactive(true);
    }
    async getUserName() {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'getUserName() exception: %s', e.message);
            throw e;
        }
    }
    async contactAlias(contactId, alias) {
        try {
            ...
            wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'contactRemark() exception: %s', e.message);
            // Issue #509 return false instead of throw when contact is not a friend.
            // throw e
            wechaty_puppet_1.log.warn('PuppetWeChatBridge', 'contactRemark() does not work on contact is not a friend');
            return false;
        }
    }
    async contactList() {
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'contactList() exception: %s', e.message);
            throw e;
        }
    }
    async roomList() {
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'roomList() exception: %s', e.message);
            throw e;
        }
    }
    async roomDelMember(roomId, contactId) {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'roomDelMember(%s, %s) exception: %s', roomId, contactId, e.message);
            throw e;
        }
    }
    async roomAddMember(roomId, contactId) {
        wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'roomAddMember(%s, %s)', roomId, contactId);
        if (!roomId || !contactId) {
            throw new Error('no roomId or contactId');
        }
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'roomAddMember(%s, %s) exception: %s', roomId, contactId, e.message);
            throw e;
        }
    }
    async roomModTopic(roomId, topic) {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'roomModTopic(%s, %s) exception: %s', roomId, topic, e.message);
            throw e;
        }
    }
    async roomCreate(contactIdList, topic) {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'roomCreate(%s) exception: %s', contactIdList, e.message);
            throw e;
        }
    }
    async verifyUserRequest(contactId, hello) {
        wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'verifyUserRequest(%s, %s)', contactId, hello);
        if (!contactId) {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'verifyUserRequest(%s, %s) exception: %s', contactId, hello, e.message);
            throw e;
        }
    }
    async verifyUserOk(contactId, ticket) {
        wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'verifyUserOk(%s, %s)', contactId, ticket);
        if (!contactId || !ticket) {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'verifyUserOk(%s, %s) exception: %s', contactId, ticket, e.message);
            throw e;
        }
    }
    async send(toUserName, text) {
        wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'send(%s, %s)', toUserName, text);
        if (!toUserName) {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'send() exception: %s', e.message);
            throw e;
        }
    }
    async getMsgImg(id) {
        ...
        try {
            ...
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'proxyWechaty(getMsgImg, %d) exception: %s', id, e.message);
            throw e;
        }
    }
    async getMsgEmoticon(id) {
        wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'getMsgEmoticon(%s)', id);
        try {
            return await this.proxyWechaty('getMsgEmoticon', id);
        }
        catch (e) {
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'proxyWechaty(getMsgEmoticon, %d) exception: %s', id, e.message);
            throw e;
        }
    }
    async getMsgVideo(id) {
        ...
        try {
            ...
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'proxyWechaty(getMsgVideo, %d) exception: %s', id, e.message);
            throw e;
        }
    }
    async getMsgVoice(id) {
        ...
        try {
            ...
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'proxyWechaty(getMsgVoice, %d) exception: %s', id, e.message);
            throw e;
        }
    }
    async getMsgPublicLinkImg(id) {
        wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'getMsgPublicLinkImg(%s)', id);
        try {
            return await this.proxyWechaty('getMsgPublicLinkImg', id);
        }
        catch (e) {
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'proxyWechaty(getMsgPublicLinkImg, %d) exception: %s', id, e.message);
            throw e;
        }
    }
    async getMessage(id) {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'getMessage() rejection: %s', e.message);
            throw e;
        }
    }
    async getContact(id) {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'getContact() rejection: %s', e.message);
            throw e;
        }
    }
    async getBaseRequest() {
        ...
        try {
            ...
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'proxyWechaty(getBaseRequest) exception: %s', e.message);
            throw e;
        }
    }
    async getPassticket() {
        ...
        try {
            ...
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'proxyWechaty(getPassticket) exception: %s', e.message);
            throw e;
        }
    }
    async getCheckUploadUrl() {
        ...
        try {
            ...
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'proxyWechaty(getCheckUploadUrl) exception: %s', e.message);
            throw e;
        }
    }
    async getUploadMediaUrl() {
        ...
        try {
            ...
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'proxyWechaty(getUploadMediaUrl) exception: %s', e.message);
            throw e;
        }
    }
    async sendMedia(mediaData) {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'sendMedia() exception: %s', e.message);
            throw e;
        }
    }
    async forward(baseData, patchData) {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'forward() exception: %s', e.message);
            throw e;
        }
    }
    /**
    ...
    async proxyWechaty(wechatyFunc, ...args) {
        wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'proxyWechaty(%s%s)', wechatyFunc, args.length === 0
            ? ''
            : ', ' + args.join(', '));
        if (!this.page) {
            throw new Error('no page');
        ...
        try {
            ...
            wechaty_puppet_1.log.warn('PuppetWeChatBridge', 'proxyWechaty() noWechaty exception: %s', e);
            throw e;
        }
    ...
    `.replace(/[\n\s]+/, ' ');
        ...
        try {
            ...
            wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'proxyWechaty(%s, %s) ', wechatyFunc, args.join(', '));
            wechaty_puppet_1.log.warn('PuppetWeChatBridge', 'proxyWechaty() exception: %s', e.message);
            throw e;
        }
    }
    ding(data) {
        ...
        this.proxyWechaty('ding', data)
            ...
            .catch(e => {
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'ding(%s) exception: %s', data, e.message);
            this.emit('error', e);
        });
    }
    preHtmlToXml(text) {
    ...
    async testBlockedMessage(text) {
        ...
        wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'testBlockedMessage(%s)', textSnip);
        let obj;
        try {
            ...
            obj = await new Promise((resolve, reject) => {
                (0, xml2js_1.parseString)(tryXmlText, { explicitArray: false }, (err, result) => {
                    if (err) {
                        return reject(err);
                    }
            ...
            wechaty_puppet_1.log.warn('PuppetWeChatBridge', 'testBlockedMessage() toJson() exception: %s', e);
            return false;
        }
        if (!obj) {
            // FIXME: when will this happen?
            wechaty_puppet_1.log.warn('PuppetWeChatBridge', 'testBlockedMessage() toJson(%s) return empty obj', textSnip);
            return false;
        }
        if (!obj.error) {
            return false;
        ...
        wechaty_puppet_1.log.warn('PuppetWeChatBridge', 'testBlockedMessage() error.ret=%s', ret);
        if (ret === 1203) {
            // <error>
            // <ret>1203</ret>
    ...
    async clickSwitchAccount(page) {
        ...
        try {
            ...
            if (button) {
                await button.click();
                wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'clickSwitchAccount() clicked!');
                return true;
            }
            else {
                wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'clickSwitchAccount() button not found');
                return false;
            }
        }
        catch (e) {
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'clickSwitchAccount() exception: %s', e);
            throw e;
        }
    }
    async hostname() {
        ...
        try {
            ...
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'hostname() got %s', hostname);
            return hostname;
        }
        catch (e) {
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'hostname() exception: %s', e);
            this.emit('error', e);
            return null;
        }
    }
    async cookies(cookieList) {
        ...
        if (cookieList) {
            try {
                ...
                wechaty_puppet_1.log.error('PuppetWeChatBridge', 'cookies(%s) reject: %s', cookieList, e);
                this.emit('error', e);
            }
            // RETURN
        }
     ...
     */
    entryUrl(cookieList) {
        wechaty_puppet_1.log.verbose('PuppetWeChatBridge', 'cookieDomain(%s)', cookieList);
        /**
         * `?target=t` is from https://github.com/wechaty/wechaty-puppet-wechat/pull/129
         */
        const DEFAULT_URL = 'https://wx.qq.com';
        if (!cookieList || cookieList.length === 0) {
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'cookieDomain() no cookie, return default %s', DEFAULT_URL);
            return DEFAULT_URL;
        }
        const wxCookieList = cookieList.filter(c => /^webwx_auth_ticket|webwxuvid$/.test(c.name));
        if (!wxCookieList.length) {
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'cookieDomain() no valid cookie, return default hostname');
            return DEFAULT_URL;
        }
        let domain = wxCookieList[0].domain;
        if (!domain) {
            wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'cookieDomain() no valid domain in cookies, return default hostname');
            return DEFAULT_URL;
        }
        ...
        wechaty_puppet_1.log.silly('PuppetWeChatBridge', 'cookieDomain() got %s', url);
        return url;
    }
    async reload() {
    ...
    async evaluate(fn, ...args) {
        ...
        try {
            ...
            wechaty_puppet_1.log.error('PuppetWeChatBridge', 'evaluate() exception: %s', e);
            this.emit('error', e);
            return null;
        }
    }
