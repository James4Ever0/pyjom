...
test('interfaceOfClass() class instance', async (t) => {
    ...
    const interfaceOfTest = interfaceOfClass(Test)();
    const test = new Test();
...
test('interfaceOfClass() for primitive types', async (t) => {
    ...
    const interfaceOfTest = interfaceOfClass(TestImpl)();
...
test('interfaceOfClass() for empty interface', async (t) => {
    ...
    t.throws(() => interfaceOfClass(Test)(), 'should throw an error for empty interface');
});
test('interfaceOfClass() for parent/child class', async (t) => {
    ...
    const interfaceOfChild = interfaceOfClass(Child)();
    const FIXTURES = [
        [new Child(), true],
        [new Parent(), false],
        [{ parent: true }, false],
