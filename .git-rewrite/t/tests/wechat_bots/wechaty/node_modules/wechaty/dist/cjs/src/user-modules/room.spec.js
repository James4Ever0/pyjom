...
(0, tstest_1.test)('room.say() smoke testing', async () => {
    const sandbox = tstest_1.sinon.createSandbox();
    const callback = tstest_1.sinon.spy();
    const puppet = new wechaty_puppet_mock_1.PuppetMock();
    const wechaty = wechaty_builder_js_1.WechatyBuilder.build({ puppet });
    ...
    // await contact2.sync()
    // await room.sync()
    (0, tstest_1.test)('say with Tagged Template', async (t) => {
    ...
    (0, tstest_1.test)('say with regular mention contact', async (t) => {
        callback.resetHistory();
    ...
    (0, tstest_1.test)('say with multiple mention contact', async (t) => {
        callback.resetHistory();
