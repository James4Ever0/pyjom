...
import { Ducks, noopReducer, } from 'ducks';
import { mock, PuppetMock, } from 'wechaty-puppet-mock';
import { getPuppet, getWechaty, } from './registry/mod.js';
import * as duck from './duck/mod.js';
import { WechatyRedux, } from './wechaty-redux.js';
async function* wechatyFixtures() {
    ...
    const store = createStore(noopReducer, devCompose(ducksEnhancer));
...
test('WechatyRedux: getPuppet() & getWechaty()', async (t) => {
    ...
    t.throws(() => wechaty.use(WechatyRedux({ store })), 'should throws without init() puppet');
    await wechaty.init();
